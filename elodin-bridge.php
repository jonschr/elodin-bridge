...
define( 'ELODIN_BRIDGE_VERSION', '1.2' );
...
require_once ELODIN_BRIDGE_DIR . '/inc/generatepress-list-margins.php';
require_once ELODIN_BRIDGE_DIR . '/inc/generatepress-static-css-experiment.php';
